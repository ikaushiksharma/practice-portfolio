  ...
  return (
    <SectionContainer>
      <div className="w-full h-full flex px-4 pt-16 sm:pt-4 sm:px-0 flex-col sm:flex-row justify-between">
        <div className="flex gap-y-10 pl-4 lg:pl-0 my-6 sm:my-10 w-full sm:w-1/3 flex-col">
          ...
          <div className="w-full flex flex-col gap-y-2">
            <h2 className="text-xl w-full sm:text-2xl font-extrabold">
              +91-7837988677
            </h2>
          ...
          <div className="w-full flex flex-row text-xs items-center justify-center sm:justify-start gap-x-4 uppercase">
        ...
        <div className="w-full my-2 sm:w-3/5">
          <Form />
        </div>
      </div>
    </SectionContainer>
